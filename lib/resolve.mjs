...
export function browserNotFoundMessage() {
  return [
    ...
    'Run from a checkout that provides ../browser/bin/webmcp.mjs, install @gyga-browser/webmcp-browser-automation-kit, or set WEBMCP_BROWSER_BIN.',
  ].join('\n');
}
