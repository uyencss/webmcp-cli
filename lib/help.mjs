...
Usage:
  ...
  ${PREVIEW_COMMAND} project policy plan|apply|upgrade [--workspace <dir>|--all] [--yes] [--json]
...
Preview routing:
  ...
  new archetype/plugin/inspect/repair/session routes delegate to the Project Kit executable.
